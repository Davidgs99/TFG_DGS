...
//}
// 
// const httpd_uri_t echo = {                                  //Send data to module from server/client
    // .uri       = "/echo",
    // .method    = HTTP_POST,
...
// const httpd_uri_t ctrl = {                                                      //Disconnect handlers (hello / echo)
//     .uri       = "/ctrl",
//     .method    = HTTP_PUT,
...
httpd_handle_t start_webserver(void)
{
    ...
    if (httpd_start(&server, &config) == ESP_OK) {                                  //Check if server's initiation was successful
        /*
        // Set URI handlers                                         UTILIZAR EL REGISTRO DE HANDLERS PARA LA TAREA
